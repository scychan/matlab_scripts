...
volts_per_pixelX=((1/state.acq.zoomFactor)*2*abs(state.internal.scanAmplitudeX))/sizeImage(2); %VI102609A %VI091508A, VI021909B
volts_per_pixelY=((1/state.acq.zoomFactor)*2*abs(state.internal.scanAmplitudeY))/sizeImage(1); %VI102609A %VI110308A
