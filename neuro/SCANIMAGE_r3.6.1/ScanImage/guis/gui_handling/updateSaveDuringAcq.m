...
%   VI052109A: Revert VI020409A, which is no longer needed. # of stripes no longer depends on saveDuringAcquisition  -- Vijay Iyer 5/21/09
%% CREDITS
...
if state.standardMode.standardModeOn %VI102809A
    ...
    %%%VI120208A%%%%%%%%%%%%%%%%
    %FIXME: Consider whether to eliminate this ugliness by calling setupDaqDevices_ConfigSpecific() instead. Another way would be to detect load-time call based on nargin.
    x = dbstack;
