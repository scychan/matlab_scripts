...
scanX=1/state.acq.zoomFactorReset*2*state.acq.roiCalibrationFactor*abs(state.internal.scanAmplitudeX); %VI102609A %VI091508A
scanY=1/state.acq.zoomFactorReset*2*abs(state.internal.scanAmplitudeY); %VI102609A %VI091508A
if scanY == 0
    return
end
