...
if state.internal.scanAmplitudeY ~= 0 & state.internal.scanAmplitudeX ~= 0 %VI102609A
    aspectRatioF = abs(state.internal.imageAspectRatioBias*state.internal.scanAmplitudeY/state.internal.scanAmplitudeX);  %VI102609A
...
for i = 1:state.init.maximumNumberOfInputChannels
    ...
    state.internal.imagehandle(i) = image('CData', startImageData, 'CDataMapping', 'Scaled', 'Parent', state.internal.axis(i), ...
        'ButtonDownFcn', 'figureButtonOverCallback','UIContextMenu',cmenu,'EraseMode','none'); %VI091009A
...
for i = 1:state.init.maximumNumberOfInputChannels
    ...
    state.internal.maximagehandle(i) = image('CData', startImageData, 'CDataMapping', 'Scaled', 'Parent', state.internal.maxaxis(i), ...
        'ButtonDownFcn', 'figureButtonOverCallback','EraseMode','none'); %VI091009A
end
