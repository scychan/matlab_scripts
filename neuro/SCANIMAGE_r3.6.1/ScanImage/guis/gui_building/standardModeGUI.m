...
% VI112309A - Revert VI111108B - no need to clear stored stack endpoints when endpoint constraint is off and either slice #/size is changed  -- Vijay Iyer 11/23/09
%
%% ****************************************************
