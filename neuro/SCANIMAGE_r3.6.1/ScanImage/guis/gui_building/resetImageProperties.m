...
aspectRatioF = abs(state.internal.imageAspectRatioBias*state.acq.scanAmplitudeY/state.acq.scanAmplitudeX); %Aspect ratio can remain based on state.acq.scanAmplitudeX/Y, rather than state.internal.scanAmplitudeX/Y -- Vijay Iyer 10/26/09
