...
if ok
    set(gh.configurationGUI.etAcqDelay,'BackgroundColor',[1 1 1]);
else
    set(gh.configurationGUI.etAcqDelay,'BackgroundColor',[1 0 0]);
    ...
    configPosn = getpixelposition(gh.configurationGUI.figure1);
